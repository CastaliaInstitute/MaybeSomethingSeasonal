...
expected = {
    ...
    ("Rosh Hashanah (Jewish New Year)", date(2035, 10, 4)),
    ("Yom Kippur (Day of Atonement)", date(2035, 10, 13)),
...
forbidden = {
    ...
    ("Rosh Hashanah (Jewish New Year)", date(2035, 9, 23)),
    ("Yom Kippur (Day of Atonement)", date(2035, 10, 2)),
